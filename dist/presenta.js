...
(function (global, factory) {
  ...
  const embed = function (el, config, sceneConfig, rootElement, projectConfig) {
    ...
    const coverFrame = `<div class="cover ${css$8.loading}"><h1>Embed from <mark>${name}</mark></h1></div>`;
